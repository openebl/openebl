...
// WeightUnit : The unit of measure which can be expressed in imperial or metric terms - KGM (Kilograms) - LBR (Pounds)
type WeightUnit string

// List of weightUnit
const (
	KGM_WeightUnit WeightUnit = "KGM"
	LBR_WeightUnit WeightUnit = "LBR"
)
