...
type Equipment struct {
	EquipmentReference string         `json:"equipmentReference,omitempty"` // Example: APZU4812090
	ISOEquipmentCode   string         `json:"ISOEquipmentCode,omitempty"`   // Example: 22GP
	TareWeight         *model.Decimal `json:"tareWeight,omitempty"`
