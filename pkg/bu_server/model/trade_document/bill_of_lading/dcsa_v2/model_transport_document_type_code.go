...
// TransportDocumentTypeCode : Specifies the type of the transport document - BOL (Bill of Lading) - SWB (Sea Waybill)
type TransportDocumentTypeCode string

// List of transportDocumentTypeCode
const (
	BOL_TransportDocumentTypeCode TransportDocumentTypeCode = "BOL"
	SWB_TransportDocumentTypeCode TransportDocumentTypeCode = "SWB"
)
