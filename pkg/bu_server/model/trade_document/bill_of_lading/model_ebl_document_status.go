...
// EblDocumentStatus : The status of the Bill of Lading. Possible values are: - RECE (Received) - PENU (Pending Update) - DRFT (Draft) - PENA (Pending Approval) - APPR (Approved) - ISSU (Issued) - SURR (Surrendered) - VOID (Void)  More details can be found on <a href=\"https://github.com/dcsaorg/DCSA-Information-Model/blob/master/datamodel/referencedata.d/shipmenteventtypecodes.csv\">GitHub</a>. Be aware that the list linked to is the `ShipmentEventTypeCodes` which is equivalent to `documentStatus`, the list is a subset of the possible values.
type EblDocumentStatus string

// List of eblDocumentStatus
const (
	RECE_EblDocumentStatus EblDocumentStatus = "RECE"
	PENU_EblDocumentStatus EblDocumentStatus = "PENU"
	DRFT_EblDocumentStatus EblDocumentStatus = "DRFT"
	PENA_EblDocumentStatus EblDocumentStatus = "PENA"
	APPR_EblDocumentStatus EblDocumentStatus = "APPR"
	ISSU_EblDocumentStatus EblDocumentStatus = "ISSU"
	SURR_EblDocumentStatus EblDocumentStatus = "SURR"
	VOID_EblDocumentStatus EblDocumentStatus = "VOID"
)
