...
type UtilizedTransportEquipment struct {
	...
	CargoGrossWeight     *model.Decimal `json:"cargoGrossWeight"`
	CargoGrossWeightUnit *WeightUnit    `json:"cargoGrossWeightUnit"`
	CargoGrossVolume     *model.Decimal `json:"cargoGrossVolume,omitempty"`
	CargoGrossVolumeUnit *VolumeUnit    `json:"cargoGrossVolumeUnit,omitempty"`
	NumberOfPackages     int32          `json:"numberOfPackages,omitempty"`
	IsShipperOwned       bool           `json:"isShipperOwned"` // Indicates whether the container is shipper owned (SOC).
