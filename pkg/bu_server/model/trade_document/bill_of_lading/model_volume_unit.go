...
// VolumeUnit : The unit of measure which can be expressed in either imperial or metric terms - FTQ (Cubic meter) - MTQ (Cubic foot)
type VolumeUnit string

// List of volumeUnit
const (
	MTQ_VolumeUnit VolumeUnit = "MTQ"
	FTQ_VolumeUnit VolumeUnit = "FTQ"
)
