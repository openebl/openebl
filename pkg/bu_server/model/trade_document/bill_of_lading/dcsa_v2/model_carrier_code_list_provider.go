...
// CarrierCodeListProvider : The provider used for identifying the issuer Code
type CarrierCodeListProvider string

// List of carrierCodeListProvider
const (
	SMDG_CarrierCodeListProvider  CarrierCodeListProvider = "SMDG"
	NMFTA_CarrierCodeListProvider CarrierCodeListProvider = "NMFTA"
)
