...
// DeliveryTypeAtDestination : Indicates the type of service offered at Destination. Options are defined in the Receipt/Delivery entity. - CY (Container yard (incl. rail ramp)) - SD (Store Door) - CFS (Container Freight Station)
type DeliveryTypeAtDestination string

// List of deliveryTypeAtDestination
const (
	CY_DeliveryTypeAtDestination  DeliveryTypeAtDestination = "CY"
	SD_DeliveryTypeAtDestination  DeliveryTypeAtDestination = "SD"
	CFS_DeliveryTypeAtDestination DeliveryTypeAtDestination = "CFS"
)
