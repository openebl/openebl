...
// CargoMovementTypeAtDestination : Refers to the shipment term at the unloading of the cargo out of the container. Options are defined in the Cargo Movement Type entity. - FCL (Full Container Load) - LCL (Less than Container Load) - BB (Break Bulk)
type CargoMovementTypeAtDestination string

// List of cargoMovementTypeAtDestination
const (
	FCL_CargoMovementTypeAtDestination CargoMovementTypeAtDestination = "FCL"
	LCL_CargoMovementTypeAtDestination CargoMovementTypeAtDestination = "LCL"
	BB_CargoMovementTypeAtDestination  CargoMovementTypeAtDestination = "BB"
)
