...
type Transport struct {
	TransportPlanStage               TransportPlanStage `json:"transportPlanStage,omitempty"`
	TransportPlanStageSequenceNumber int32              `json:"transportPlanStageSequenceNumber"`
	LoadLocation                     *Location          `json:"loadLocation"`
	DischargeLocation                *Location          `json:"dischargeLocation"`
	PlannedDepartureDate             *model.Date        `json:"plannedDepartureDate"`
	PlannedArrivalDate               *model.Date        `json:"plannedArrivalDate"`
	...
	UniversalImportVoyageReference   string             `json:"universalImportVoyageReference,omitempty"`
