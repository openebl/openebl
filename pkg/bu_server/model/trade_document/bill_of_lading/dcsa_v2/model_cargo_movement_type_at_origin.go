...
// CargoMovementTypeAtOrigin : Refers to the shipment term at the loading of the cargo into the container. Options are defined in the Cargo Movement Type entity. - FCL (Full Container Load) - LCL (Less than Container Load) - BB (Break Bulk)
type CargoMovementTypeAtOrigin string

// List of cargoMovementTypeAtOrigin
const (
	FCL_CargoMovementTypeAtOrigin CargoMovementTypeAtOrigin = "FCL"
	LCL_CargoMovementTypeAtOrigin CargoMovementTypeAtOrigin = "LCL"
	BB_CargoMovementTypeAtOrigin  CargoMovementTypeAtOrigin = "BB"
)
